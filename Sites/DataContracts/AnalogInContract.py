...
class AnalogInContract:
    ...
    def __init__(self):
        ...
        self.pgCryoPump = 0    # ADC 12- Pfeiffer gauge Analog Pressure Reading for the Cryp-Pump
    ...
    def update(self, d):
        ...
        if 'ADC 12' in d:
            self.pgCryoPump = d['ADC 12']  # todo: add conversion to value from ADC counts
        if 'ADC 13' in d:
